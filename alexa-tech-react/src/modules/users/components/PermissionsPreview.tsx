...
const PERMISSION_NAMES: Record<string, { name: string; module: string }> = {
  ...
  'clients.create': { name: 'Crear Clientes', module: 'Clientes' },
  'clients.read': { name: 'Ver Clientes', module: 'Clientes' },
  'clients.update': { name: 'Actualizar Clientes', module: 'Clientes' },
  'clients.delete': { name: 'Eliminar Clientes', module: 'Clientes' },
